...
public class CharSolver {
  ...
  private class SearchNode {
    ...
    private SearchNode(CharBoard board, int moves, SearchNode previous) {
      this.board = board;
      this.moves = moves;
  ...
  private Stack<CharBoard> solution = new Stack<>();

  // find a solution to the initial board (using the A* algorithm)
  public CharSolver(CharBoard initial) {
    if (initial == null) {
    ...
    while (true) {
      ...
      for (CharBoard neighbor : currentSearchNode.board.neighbors()) {
  ...
  public Iterable<CharBoard> solution() {
